...
proc drawInfo*(asciiArt: bool) =
  ...
  stdout.styledWrite("  │ ", color1, editorIcon, color0, editorCat, color1, editorInfo, color0, "\n")
  if not wmInfo.isEmptyOrWhitespace():
    stdout.styledWrite("  │ ", color2, wmIcon, color0, wmCat, color2, wmInfo, color0, "\n")
  stdout.styledWrite("  │ ", color3, pkgsIcon, color0, pkgsCat, color3, pkgsInfo, color0, "\n")
  stdout.styledWrite("  │ ", color4, ramIcon, color0, ramCat, color4, ramInfo, color0, "\n")
  stdout.styledWrite("  ├───────────┤\n")
